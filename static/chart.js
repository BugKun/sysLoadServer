        ...
        tooltip: {
            ...
            formatter: function (params) {
                ...
                for(var i = 0;i <params.length;i++){
                    ...
                    }else if(params[i].seriesIndex === 0){
                    ...
                    optionToContent: function(opt) {
                        ...
                        for (var i = 0, l = axisData.length; i < l; i++) {
                            table += '<tr>'
                                ...
                                + '<td>' + toDisplayMem(series[1].data[i].totalMem) + '</td>'
                                + '<td>' + toDisplayMem(series[1].data[i].usedMem) + '</td>'
                                + '<td>' + toDisplayMem(series[1].data[i].freeMem) + '</td>'
                                + '</tr>';
                        }
                        table += '</tbody></table>';
                        return table;
